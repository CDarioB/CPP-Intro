...
// Sobrecarga Operador ==
bool Complejo::operator==(const Complejo& otro) const
{
    return (parteReal == otro.parteReal) &&
           (parteImg  == otro.parteImg);    //  Implementar != usando == evita duplicar lógica
}

// Sobrecarga Operador !=
bool Complejo::operator!=(const Complejo& otro) const
{
    return !(*this == otro); // Implementar != usando == evita duplicar lógica
}
